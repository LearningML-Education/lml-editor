...
test.describe('Upload dataset flow', () => {
  test('File -> Upload dataset -> insectos.json (twice) creates classes in GUI', async ({ page }) => {
    const fixturePath = path.join(process.cwd(), 'tests/fixtures/insectos.json');
